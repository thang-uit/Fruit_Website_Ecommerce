...
<body>
    ...
    <a class="btn" href="javascript:history.back()">&#8592; Trờ Lại Trái Đất!</a>
    <p class="center-404">Những kẻ xâm lược đã phá hủy trang này! Hãy trả thù chúng!
        <br/> 
        Sử dụng <span class="label label-danger">phím <strong> | Space |</strong></span> để bắn và
        <span class="label label-danger"><strong>| ⬅ </strong></span>&#160;<span class="label label-danger"><strong> ➡ |</strong></span> để di chuyển!&#160;&#160;&#160;
        <button class="btn" style="outline: none; border: none;" id="restart">Chơi lại</button>
    </p>

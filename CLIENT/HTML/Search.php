            ...
            <div class="row row-2">
                ...
                ?>
                        <select id="sortbox" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);"> 
                            <option value="?Search=<?= $search ?>&field=Pro_ID&sort=ASC" selected><p>Sắp xếp mặc định</p></option>
                            <option value='?Search=<?= $search ?>&field=Pro_Price&sort=ASC' <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_Price" && isset($_GET['sort']) && $_GET['sort'] == "ASC"){ ?> selected <?php } ?>><p> GIÁ &nbsp; &nbsp;tăng dần</p></option>
                            <option value="?Search=<?= $search ?>&field=Pro_Price&sort=DESC" <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_Price" && isset($_GET['sort']) && $_GET['sort'] == "DESC"){ ?> selected <?php } ?>><p> GIÁ &nbsp; &nbsp;giảm dần</p></option>
                            <option value="?Search=<?= $search ?>&field=Pro_Rate&sort=ASC" <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_Rate" && isset($_GET['sort']) && $_GET['sort'] == "ASC"){ ?> selected <?php } ?>><p> ĐÁNH GIÁ &nbsp; &nbsp;tăng dần</p></option>
                            <option value="?Search=<?= $search ?>&field=Pro_Rate&sort=DESC" <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_Rate" && isset($_GET['sort']) && $_GET['sort'] == "DESC"){ ?> selected <?php } ?>><p> ĐÁNH GIÁ &nbsp; &nbsp;giảm dần</p></option>
                            <option value="?Search=<?= $search ?>&field=Pro_View&sort=ASC" <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_View" && isset($_GET['sort']) && $_GET['sort'] == "ASC"){ ?> selected <?php } ?>><p> SỐ LƯỢT XEM &nbsp; &nbsp;tăng dần</p></option>
                            <option value="?Search=<?= $search ?>&field=Pro_View&sort=DESC" <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_View" && isset($_GET['sort']) && $_GET['sort'] == "DESC"){ ?> selected <?php } ?>><p> SỐ LƯỢT XEM &nbsp; &nbsp;giảm dần</p></option>
                            <option value="?Search=<?= $search ?>&field=Pro_Name&sort=ASC" <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_Name" && isset($_GET['sort']) && $_GET['sort'] == "ASC"){ ?> selected <?php } ?>><p> BẢNG CHỮ CÁI &nbsp; &nbsp;(A - Z)</p></option>
                            <option value="?Search=<?= $search ?>&field=Pro_Name&sort=DESC" <?php if(isset($_GET['field']) && $_GET['field'] == "Pro_Name" && isset($_GET['sort']) && $_GET['sort'] == "DESC"){ ?> selected <?php } ?>><p> BẢNG CHỮ CÁI &nbsp; &nbsp;(Z - A)</p></option>
                        </select>
                <?php
                    }
                ?>

...
<body>
    <a class="btn" href="javascript:history.back()">&#8592; Come back to The Earth</a>
    <p class="center-404">Space Invadors destroyed this page! Take revenge on them!
        <br/> 
        Use <span class="label label-danger"><strong> | Space | </strong></span> to shoot and
        <span class="label label-danger"><strong>| ⬅ </strong></span>&#160;<span class="label label-danger"><strong> ➡ |</strong></span> to move!&#160;&#160;&#160;
        <button class="btn" style="outline: none; border: none;" id="restart">Restart</button>
    </p>
